    ...
    <div className="gradient-cards">
      <div className="card">
        <div className="container-card bg-green-box">
          ...
          <p className="card-description">
            Hubble lets users borrow USDH for a one-time 0.5% fee. No variable
      ...
      <div className="card">
        <div className="container-card bg-white-box">
          ...
          <p className="card-description">
            Deposit a variety of assets on Hubble, raise your collateral ratio,
            and unlock the liquidity in your wallet.
          </p>
        </div>
      </div>
      <div className="card">
        <div className="container-card bg-yellow-box">
          ...
          >
            ...
            <defs>
              ...
              >
                ...
                <stop offset="0.510417" stopColor="#FFE34B" stopOpacity={0} />
          ...
          <p className="card-description">
            While your collateral is deposited, delegate it to earn the highest
            yield available in the Solana ecosystem.
          </p>
        </div>
      </div>
      <div className="card">
          ...
          >
            ...
            <defs>
              ...
              >
                ...
                <stop offset="0.489583" stopColor="#61A0FF" stopOpacity={0} />
